...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.ci.docopener.js')
	...
	f = os.path.join(cwd,'Classes','ComCiDocopenerModuleAssets.m')
	c = open(f).read()
	idx = c.find('return ')
	before = c[0:idx]
	after = """
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.ci.docopener.js']
